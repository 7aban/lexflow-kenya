      ...
      <main style={styles.main}>
        ...
        <div className="lf-page-inner" style={styles.pageInner}>
          ...
          <ViewErrorBoundary resetKey={view} onReset={() => navigateToView('Dashboard', { replace: true })}>
            ...
            {(!loading || bootstrapped) && view === 'Documents' && <DocumentsExplorer notify={setToast} canManage={isAdmin || user?.role === 'advocate'} allowArchived={isAdmin || user?.role === 'advocate'} onOpenMatter={(matterId, documentFocus = {}) => navigateToView('Matters', { matterId, section: 'documents', ...documentFocus })} />}
